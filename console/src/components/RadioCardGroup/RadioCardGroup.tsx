import {
  ...
  export const RadioCardGroup = <T extends string>(props: RadioCardGroupProps<T>) => {
    ...
    return <Stack direction="row" spacing={0} gap={4} wrap={"wrap"} {...getRootProps(rest)}>{cards}</Stack>
  }
  ...
  export const RadioCard = (props: RadioCardProps) => {
    ...
    return (
      ...
      >
        ...
        <Box p={4} borderRadius={"md"} bg={"whiteAlpha.200"} {...checkboxProps} {...rest}>
          <Stack direction="row">
            <Box>{children}</Box>
            {state.isChecked ? (
              <Circle bg="orange.500" size="4">
