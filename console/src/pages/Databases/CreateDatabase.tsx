          ...
          <DrawerBody>
            ...
            <FormControl isRequired mt={8}>
              ...
              <Input
                ...
                onChange={(e) => setDatabaseDetails({...databaseDetails,port:Number(e.target.value)})}
              />
            </FormControl>
            <FormControl isRequired mt={8}>
              ...
              <Select
                id="database-type"
                onChange={(e) => setDatabaseDetails({...databaseDetails,type:e.target.value})}
                value={databaseDetails.type}
              >
