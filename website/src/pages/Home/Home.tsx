        ...
        <section className="px-2 py-32 md:px-0 tails-selected-element">
            <div className="container items-center max-w-6xl px-5 mx-auto space-y-8 text-center">
                ...
                <div className="flex flex-col justify-center md:flex-row md:space-x-4">
                    ...
                    <a href="https://docs.faasbase.com" target={"_blank"} className="flex items-center px-6 py-3 font-medium text-black bg-white rounded-md hover:bg-gray-100" data-rounded="rounded-md">
                        Documentation
...
const FeaturesSection = () => {
    const features = [
        ...
        },
        {
            ...
            description:
                'Faasbase can deploy functions and applications to your cloud providers with automatic deployments or by push of a button from our dashboard.',
            icon: FiServer,
        },
    ]
    ...
    const features = [
        {
            ...
            description:
                'Faasbase sponsors open source projects and events and invests in improving the open source ecosystem.',
            icon: FiGlobe,
        },
        {
            name: 'Collaborate with the Community',
            description:
                'Create function/application bounties and collaborate with the community to build applications faster',
            icon: FiTool,
        },
    ]
            ...
            <div className="my-16 container rounded-2xl mx-auto w-full p-16 pt-24">
                <div className="flex flex-col justify-center items-center mobile-mb-60">
                    ...
                    <p className="mt-4 max-w-2xl text-xl text-center text-zinc-500 lg:mx-auto text-mobile">
                        Join our community of developers and build applications collaboratively.
                    </p>
                </div>
                <div className="flex justify-around items-center gap-12 p-20 mobile-column mobile-p-0">
                    ...
                    <div className="flex flex-col gap-6 justify-between items-start rounded-md bg-zinc-800 ring-zinc-700 ring-1 p-8 flex-1">
                        ...
                        <div className="flex flex-col gap-5">
                            <div> <span className="text-xl font-semibold text-white">Github</span></div>
                            <div> <p className="text-zinc-400 text-sm">Check out our open source repo, request new features, or contribute.</p> </div>
                            <div> <a href="https://github.com/faasbase" target={"_blank"} className="flex items-center justify-center rounded-md bg-zinc-500 px-4 py-2 font-medium text-white shadow-sm">Open Source Repos</a></div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-6  justify-between items-start rounded-md bg-zinc-800 ring-zinc-700 ring-1 p-8 flex-1">
                        <div className="flex justify-center items-center w-16 h-16 bg-white rounded-md p-2">
                        ...
                        <div className="flex flex-col gap-5">
                            <div> <span className="text-xl font-semibold text-white">Twitter</span></div>
                            <div> <p className="text-zinc-400 text-sm">Follow us on twitter to stay up to date in product and event announcements.</p> </div>
                            <div> <a href="https://twitter.com/faasbase" target={"_blank"} className="flex items-center justify-center rounded-md bg-sky-500 px-4 py-2 font-medium text-white shadow-sm">Follow Us</a></div>
                        </div>
                    </div>
                </div>
            </div>
